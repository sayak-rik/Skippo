...
const styles = StyleSheet.create({
  ...
  alertIcon: { fontSize: 44 },
  alertTitle: { fontSize: 20, fontWeight: "900", color: palette.ink, textAlign: "center" },
  alertBody: { fontSize: 14, color: palette.inkSoft, textAlign: "center", lineHeight: 21 },
  broadcastBtn: {
  ...
  sentIcon: { fontSize: 36, color: palette.success },
  sentTitle: { fontSize: 18, fontWeight: "900", color: palette.ink },
  sentBody: { fontSize: 14, color: palette.inkSoft, textAlign: "center", lineHeight: 21 },
  section: { gap: 4 },
  sectionTitle: { fontSize: 16, fontWeight: "800", color: palette.ink },
  ...
  vehicleDist: { fontSize: 12, color: palette.brand, fontWeight: "600", marginTop: 1 },
  callBtn: {
