...
const styles = StyleSheet.create({
  ...
  infoText: { flex: 1, fontSize: 14, color: palette.inkSoft, lineHeight: 20 },
  ...
  sosBtnTitle: { fontSize: 26, fontWeight: "900", color: "#fff", letterSpacing: -0.3 },
  sosBtnSub: { fontSize: 13, color: "rgba(255,255,255,0.8)", textAlign: "center" },
  ...
  breakdownEmoji: { fontSize: 30 },
  breakdownTitle: { fontSize: 20, fontWeight: "900", color: "#fff" },
